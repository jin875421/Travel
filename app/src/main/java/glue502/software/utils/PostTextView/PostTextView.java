...
public class PostTextView extends androidx.appcompat.widget.AppCompatTextView {
    private String TAG = "PostTextView";
    ...
    public PostTextView(Context context, AttributeSet set) {
        super(context, set);
    ...
    public ArrayList<LinePar> getLineParList(String mTextStr) {
        ...
        for (int i = 0; i < mTextStr.length(); i++) {
            ...
            if (str != null && str.isEmpty() == false) {
                strWidth = PTVConstant.getWidthofString(str, mPaint);
            }
            /*
             * 如果是换行符，将这一行的信息存入列表中
             */
            if (ch == '\n' && tempStart != i) {
                ...
                if (tempLineWidth >= mTextWidth - mPaddingRight) {
                    ...
                    if (PTVConstant.isLeftPunctuation(ch) == true) {
                    ...
                    } else if (PTVConstant.isRightPunctuation(ch) == true) {
                        ...
                        if (i == (mTextStr.length() - 1)) {
                            ...
                            if ((PTVConstant.isHalfPunctuation(nextChar) == true || PTVConstant
                         ...
                         * punctuation.
                         */
                        if (PTVConstant.isHalfPunctuation(ch) == true
                                || PTVConstant.isPunctuation(ch) == true) {
                            ...
                            if (i >= 1) {
                                ...
                                if (PTVConstant.isLeftPunctuation(preChar) == true) {
        ...
        for (int lineNum = 0; lineNum < tempLineArray.size(); lineNum++) {
            ...
            for (int strNum = start; strNum <= end; strNum++) {
                ...
                if (strNum >= start && strNum <= end && lineCount >= 1) {
                    ...
                    lineWidth += PTVConstant.getWidthofString(str, mPaint);
    ...
    public String getTextString(Context mContext, String mText) {
        if (mContext != null && mText != null && mText.equals("") == false) {
            return PTVConstant.replaceTABToSpace(mText);
        }
        return "";
