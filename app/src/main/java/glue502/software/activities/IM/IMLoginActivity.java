...
public class IMLoginActivity extends AppCompatActivity {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override public void run() {
                            ...
                            Toast.makeText(IMLoginActivity.this, "注册成功", Toast.LENGTH_LONG).show();
                        }
                    });
    ...
    private void signIn() {
        ...
        if (TextUtils.isEmpty(username) || TextUtils.isEmpty(password)) {
            Toast.makeText(IMLoginActivity.this, "用户名和密码不能为空", Toast.LENGTH_LONG).show();
            return;
        }
            ...
            @Override public void onSuccess() {
                runOnUiThread(new Runnable() {
                    @Override public void run() {
                        ...
                        // 登录成功跳转界面
                        Intent intent = new Intent(IMLoginActivity.this, MainIMActivity.class);
